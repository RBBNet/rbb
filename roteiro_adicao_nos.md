...
```bash
curl -#SL https://github.com/RBBNet/start-network/archive/refs/tags/v1.2.0.tar.gz | tar xz
mv start-network-1.2.0 start-network
```
...
Para cada novo nó:
```bash
export IMAGE_BESU=hyperledger/besu:25.5.0
