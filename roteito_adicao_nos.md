...
Os nós participantes de uma rede RBB devem seguir o [padrão estabelecido](padrao_nome_nos.md), que compreende o padrão `<tipo_no><sequencial>`. Usualmente, o primeiro nó de um certo tipo tem o sequencial `01`. Fica a cargo de cada partícipe adequar o sequencial de acordo com a configuração desejada em sua infraestrutura.
